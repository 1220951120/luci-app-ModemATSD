...
function btn_send2.write()
    os.execute("/usr/bin/modem-led-control-AK68.sh 0 cmode4")
    os.execute("/usr/bin/modem-led-control-AK68.sh 0 cmode5")
    os.execute("/usr/bin/modem-led-control-AK68.sh 0 wifi")
    os.execute("/usr/bin/modem-led-control-AK68.sh 0 status")
    os.execute("/usr/bin/modem-led-control-AK68.sh 0 sig1")
    os.execute("/usr/bin/modem-led-control-AK68.sh 0 sig2")
    os.execute("/usr/bin/modem-led-control-AK68.sh 0 sig3")
    os.execute("/usr/bin/modem-led-control-AK68.sh 0 int")
...
function btn_send3.write()
    os.execute("/usr/bin/modem-led-control-AK68.sh 1 cmode4")
    os.execute("/usr/bin/modem-led-control-AK68.sh 1 cmode5")
    os.execute("/usr/bin/modem-led-control-AK68.sh 1 wifi")
    os.execute("/usr/bin/modem-led-control-AK68.sh 1 status")
    os.execute("/usr/bin/modem-led-control-AK68.sh 1 sig1")
    os.execute("/usr/bin/modem-led-control-AK68.sh 1 sig2")
    os.execute("/usr/bin/modem-led-control-AK68.sh 1 sig3")
    os.execute("/usr/bin/modem-led-control-AK68.sh 1 int")
